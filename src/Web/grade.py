...
STYLE_SKELETON = {'font': None, 'size': None, 'line_spacing': None, 'after_spacing': None,
                      'before_spacing': None, 'page_width': None, 'page_height': None, 'left_margin': None, 'bottom_margin': None,
                      'right_margin': None, 'top_margin': None, 'header': None, 'footer': None, 'gutter': None, 'indent': None}
...
class Grade:
    ...
    def get_grade(self, text, filepath):
        ...
        return debug, max(grade, 0), output, t
